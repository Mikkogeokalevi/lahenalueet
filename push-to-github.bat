@echo off
setlocal
set "REPO_URL=https://github.com/Mikkogeokalevi/lahenalueet.git"
set "LAST_STEP=aloitus"

cd /d "c:\Users\Tompe\Documents\lahen_alueet_versio2"

echo.
echo =========================================
echo Git-päivitysskripti GitHubiin
echo Lahen Alueiden Mysteeri
echo =========================================
echo.
...
echo =========================================
echo.
echo Sivut löytyvät osoitteesta:
echo https://mikkogeokalevi.github.io/lahenalueet/
echo.
pause
goto :eof
